...
export const milestones: Milestone[] = [
  ...
  { id: 'gpt5', name: 'GPT-5', year: 2025, era: 'singularity', description: { it: "Modello di nuova generazione atteso con capacita' avanzate di ragionamento", en: 'Next-generation model expected with advanced reasoning capabilities' }, significance: 7, category: 'model', creator: 'OpenAI' },
